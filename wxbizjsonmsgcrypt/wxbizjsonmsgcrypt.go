...
type WXBizJsonMsg4Send struct {
	Encrypt   string `json:"encrypt" xml:"encrypt"`
	Signature string `json:"msgsignature" xml:"msgsignature"`
...
func (self *XMLProcessor) parse(src_data []byte) (*WXBizJsonMsg4Recv, *CryptError) {
	var msg4_recv WXBizJsonMsg4Recv
...
func (self *XMLProcessor) serialize(msg4_send *WXBizJsonMsg4Send) ([]byte, *CryptError) {
...
func (self *WXBizMsgCrypt) GetRandString(n int) string {
	return self.randString(n)
}
...
func (self *WXBizMsgCrypt) GetSignature(timestamp, nonce, data string) string {
	return self.calSignature(timestamp, nonce, data)
}
...
func (self *WXBizMsgCrypt) GetEncryptMsg(reply_msg, timestamp, nonce string) (ciphertext string, signature string, err *CryptError) {
	rand_str := self.randString(16)
	var buffer bytes.Buffer
	buffer.WriteString(rand_str)
